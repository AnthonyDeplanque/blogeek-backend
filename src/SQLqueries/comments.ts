...
const deleteCommentByArticleQuery = (id: string) => {
  return db.query(`DELETE FROM COMMENTS WUERE id_article=?`, [id]);
}

module.exports = { getAllCommentsFromAnArticleQuery, getAllCommentsFromAnUserQuery, getAllCommentsQuery, postCommentQuery, updateCommentQuery, deleteCommentByArticleQuery, deleteCommentQuery };